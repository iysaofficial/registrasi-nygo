...
function IndoensiaParticipants() {
  ...
  const generatePaymentLink = async () => {
    if (
      selectedCategory !== "NYGO Online Competition" &&
      selectedCategory !== "NYGO Offline Competition" 
    ) {
      alert(
  ...
  useEffect(() => {
    if (selectedCategory === "NYGO Online Competition") {
      setPrice("300000");
    } else if (selectedCategory === "NYGO Offline Competition") {
      setPrice("1150000");
    } else {
      setPrice("");
    }
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbxWZAsa84Ds0tTzRQMZl2IpiXjdLc-EXjylvCUUPSxxodPJHXjgSFQVdutxE2duL_QU-Q/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br></br>
            <h4>
              HALLO PESERTA NYGO 2024, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="NYGO Online Competition">
                      Kompetisi Online
                    </option>
                    <option value="NYGO Offline Competition">
                      Kompetisi Offline
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi NYGO 2024
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
                  ...
                  >
                    ...
                    <option value="NYGO Instagram">NYGO Instagram</option>
                    ...
                    <option value="NYGO Website">NYGO Website</option>
                    <option value="IYSA Email">IYSA Email</option>
                    <option value="NYGO Email">NYGO Email</option>
